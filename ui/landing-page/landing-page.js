...
const releaseNoteTemplate = `<h5 class="change text-white-50 mx-auto mt-2 mb-2"><span class="badge badge-@COLOR mr-2">@TYPE</span>@NOTE (Thanks to <a href='https://github.com/@AUTHOR'>@@AUTHOR</a> for PR <a href='https://github.com/shanalikhan/code-settings-sync/pull/@PR'>#@PR</a>)</h5>`;
